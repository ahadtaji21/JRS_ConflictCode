                  ...
                  >
                    <template v-slot:activator="{ on }">
                      <v-btn
                        ...
                        @click="AddNewPrc()"
                      >
                        <v-icon>mdi-plus-circle-outline</v-icon>ADD PROCESS
                      </v-btn>
                    </template>
...
import SearchTable from "../PROCESS/AnnualPlanProcessSearchForm.vue";
// import ItemDetails from "./AnnualPlanItemDetailsForm.vue";
// import ItemMainData from "./AnnualPlanItemMainDataForm.vue";
import ProcessDetails from "../PROCESS/AnnualPlanProcessDetailsForm.vue";
import Output from "./AnnualPlanCascOutpForm.vue";
...
export default Vue.extend({
  ...
  methods: {
    ...
    closeOutputDialog(item: string) {
      let localThis: any = this as any;
      localThis.showProcDetails = false;
    ...
    checkboxUpdated(newValue: any, index: number, prc_id: number, item: any) {
      let localThis: any = this as any;
      ...
      for (i = 0; i < count; i++) {
        ...
        localThis.showOutputs = newValue;
        if (newValue) {
          localThis.selectedActivityId = prc_id;
          localThis.selectedProcessId = item.PMS_PROCESS_ID;
          localThis.keyRnd = Math.ceil(Math.random() * 1000);
          localThis.showOutputs = true;
        }
      }
    },
    ...
    editProcess(item: any) {
      ...
      localThis.showProcDetails = true;
