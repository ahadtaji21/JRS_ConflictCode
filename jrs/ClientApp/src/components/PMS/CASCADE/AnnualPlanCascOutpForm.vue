            ...
            <span v-if="!onlyRead">
              ...
              >
                <template v-slot:activator="{ on }">
                  ...
                  >
                    <v-icon>mdi-plus-circle-outline</v-icon>ADD OUTPUT
                  </v-btn>
                </template>
...
import SearchTable from "../OUTPUTS/AnnualPlanOutputSearch.vue";
// import ItemDetails from "./AnnualPlanItemDetailsForm.vue";
// import ItemMainData from "./AnnualPlanItemMainDataForm.vue";
import ItemOutput from "../OUTPUTS/AnnualPlanOutputDetailsForm.vue";
