          ...
          <v-tab-item key="MAINDATA">
            <v-card class="mx-my-0 pa-0">
              <ap-sssmain-data
                ...
                @closeDialogSSS="returnToProcessList"
...
import AnnualPlanSSSMainData from "./AnnualPlanSSSMainDataForm.vue";
import UtilMix from "../../../mixins/UtilMix";
// import Indicators from "./AnnualPlanSSSIndicatorForm.vue";
...
export default Vue.extend({
  components: {
    "ap-sssmain-data": AnnualPlanSSSMainData,
