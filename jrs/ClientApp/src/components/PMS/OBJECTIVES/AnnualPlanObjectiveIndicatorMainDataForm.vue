...
export default Vue.extend({
  ...
  methods: {
    ...
    save: function () {
      ...
      if (
        localThis.localFormData.objIndicatorRelId == undefined ||
        localThis.localFormData.objIndicatorRelId == 0
      ) {
        msg = this.$i18n
    ...
    updateItem(end_date: Date) {
      ...
      let localThis = this as any;
      let payLoadD = {} as any;
      payLoadD.PMS_OBJ_ID = localThis.selectedObjId;
      payLoadD.PMS_OBJ_IND_ID = localThis.localFormData.objIndicatorId;
      payLoadD.STANDARD = localThis.localFormData.STANDARD;
      payLoadD.END_DATE = end_date;
      payLoadD.VALUE = localThis.localFormData.VALUE;
      if (localThis.localFormData.objIndicatorRelId == undefined)
        payLoadD.PMS_OBJ_IND_REL_ID = 0;
      else payLoadD.PMS_OBJ_IND_REL_ID = localThis.localFormData.objIndicatorRelId;
      ...
      localThis
        ...
        .then((res: any) => {
          ...
          localThis.$emit("closeDialogeAndSaveObjInd", null);
        })
        .catch((err: any) => {
          localThis.showNewSnackbar({
            typeName: "error",
