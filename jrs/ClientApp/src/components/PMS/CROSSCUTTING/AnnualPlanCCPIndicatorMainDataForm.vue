...
export default Vue.extend({
  ...
  methods: {
    ...
    save: function () {
      ...
      if (
        localThis.localFormData.ccpIndicatorRelId == undefined ||
        localThis.localFormData.ccpIndicatorRelId == 0
      ) {
        msg = this.$i18n
    ...
    updateItem(end_date: any) {
      ...
      payLoadD.PMS_IND_ID = localThis.localFormData.ccpIndicatorId;
      payLoadD.PMS_CCP_ID = localThis.localFormData.ccpId;
      payLoadD.VALUE = localThis.localFormData.VALUE;
      payLoadD.END_DATE = end_date;
      if (localThis.localFormData.ccpIndicatorRelId == undefined)
        payLoadD.PMS_CCP_IND_REL_ID = 0;
      else payLoadD.PMS_CCP_IND_REL_ID = localThis.localFormData.ccpIndicatorRelId;
      let savePayload: GenericSqlPayload = {
        spName: "PMS_SP_INS_CCP_INDICATOR",
      ...
      localThis
        ...
        .then((res: any) => {
          ...
          localThis.$emit("closeDialogeAndSaveCCPInd", null);
        })
        .catch((err: any) => {
          localThis.showNewSnackbar({
            typeName: "error",
