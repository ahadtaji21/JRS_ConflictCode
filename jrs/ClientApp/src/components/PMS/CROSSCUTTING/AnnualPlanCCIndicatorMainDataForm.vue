...
export default Vue.extend({
  ...
  methods: {
    ...
    save: function () {
      ...
      if (
        localThis.localFormData.ccIndicatorRelId == undefined ||
        localThis.localFormData.ccIndicatorRelId == 0
      ) {
        msg = this.$i18n
    ...
    updateItem(end_date: any) {
      ...
      payLoadD.PMS_IND_ID = localThis.localFormData.ccIndicatorId;
      payLoadD.PMS_CC_ID = localThis.localFormData.selectedCCKeyId;
      payLoadD.VALUE = localThis.localFormData.VALUE;
      payLoadD.END_DATE = end_date;
      if (localThis.localFormData.ccIndicatorRelId == undefined)
        payLoadD.PMS_CC_IND_REL_ID = 0;
      else payLoadD.PMS_CC_IND_REL_ID = localThis.localFormData.ccIndicatorRelId;
      ...
      localThis
        ...
        .then((res: any) => {
          ...
          localThis.$emit("closeDialogeAndSaveCCInd", null);
        })
        .catch((err: any) => {
          localThis.showNewSnackbar({
            typeName: "error",
