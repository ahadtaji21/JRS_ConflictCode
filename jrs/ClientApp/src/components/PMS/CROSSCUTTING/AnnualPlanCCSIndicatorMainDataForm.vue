...
export default Vue.extend({
  ...
  methods: {
    ...
    save: function () {
      ...
      if (
        localThis.localFormData.ccsIndicatorRelId == undefined ||
        localThis.localFormData.ccsIndicatorRelId == 0
      ) {
        msg = this.$i18n
    ...
    updateItem(end_date: any) {
      ...
      let localThis = this as any;
      let payLoadD = {} as any;
      payLoadD.PMS_AP_ID = localThis.annal_plan_id;
      payLoadD.PMS_IND_ID = localThis.localFormData.ccsIndicatorId;
      payLoadD.PMS_CCS_ID = localThis.localFormData.ccsId;
      payLoadD.VALUE = localThis.localFormData.VALUE;
      payLoadD.END_DATE = end_date;
      if (localThis.localFormData.ccsIndicatorRelId == undefined)
        payLoadD.PMS_CCS_IND_REL_ID = 0;
      else payLoadD.PMS_CCS_IND_REL_ID = localThis.localFormData.ccsIndicatorRelId;
      let savePayload: GenericSqlPayload = {
        spName: "PMS_SP_INS_CCS_INDICATOR",
      ...
      localThis
        ...
        .then((res: any) => {
          ...
          localThis.$emit("closeDialogeAndSaveCCSInd", null);
        })
        .catch((err: any) => {
          localThis.showNewSnackbar({
            typeName: "error",
