              ...
              <template v-slot:body="{ items }">
                <tbody style="border: solid">
                  <tr v-for="item in items" :key="item.id" style="height: 10px">
                    ...
                    <td class="tablerow">{{ item.version_number }}</td>
  ...
  data() {
    return {
      ...
      columnsTemplate: [
        ...
        {
          text: "Version",
          textKey: "datasource.pms.annual-plan.ap-version",
          align: "center",
  ...
  methods: {
    ...
    getPMSAP() {
      ...
      let selectPayload: GenericSqlSelectPayload = {
        viewName: "PMS_VI_ANNUAL_PLAN_LIST_VERSION",
        colList: null,
    ...
    editItem(item: any) {
      ...
      switch (localThis.module.toUpperCase()) {
        case "'PMS'": 
          localThis.$router.push({
            ...
            params: {
              ...
              versioned: localThis.editedItem.version_id,
            },
          });
          break;
        case "IMP":
