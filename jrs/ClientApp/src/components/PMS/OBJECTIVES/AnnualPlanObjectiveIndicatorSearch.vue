  ...
  <div>
          ...
          >
            <template v-slot:top>
              <div class="d-inline-flex align-center primary lighten-2 jrs-table-top">
                <h3>
                  {{ $t("datasource.pms.annual-plan.objectives.outcome-indicators") }}
                </h3>
    ...
    >
      <pms-obj-ind-det-form
        @closeObjDetDialoge="closeDialog"
        @closeDialogeAndSaveObjInd="closeDialogAndSave"
        :formData="formData"
...
export default Vue.extend({
  ...
  methods: {
    ...
    updateValue(newVal: String) {
      (this as any).$emit("UpdateOUTCIndicators", newVal);
    },
    getItems() {
      let localThis: any = this as any;
      ...
      let selectPayload: GenericSqlSelectPayload = {
        viewName: "PMS_VI_OUTCOME_INDICATOR",
        // colList:
        //   "PMS_OBJ_IND,PMS_OBJ_IND_ID,PMS_OBJ_IND_STANDARD,PMS_OBJ_IND_PERIODICITY,PMS_OBJ_IND_TECHNIQUE,PMS_OBJ_IND_DISAGGREGATED", // "PMS_OBJ_IND_QUESTION,PMS_OBJ_IND,PMS_OBJ_IND_ID",
     
        colList:
          "PMS_OBJ_IND,PMS_OBJ_IND_ID,PMS_OBJ_IND_TECHNIQUE", // "PMS_OBJ_IND_QUESTION,PMS_OBJ_IND,PMS_OBJ_IND_ID",
     
     whereCond: `PMS_OBJ_ID = ${localThis.selectedObjId}`, // AND IMS_LANGUAGE_LOCALE='${i18n.locale}'`,
              ...
              if (localThis.indicatorsAlreadyAdded != undefined) {
                if (
                  localThis.indicatorsAlreadyAdded.filter(
                    (itemL: any) => itemL.PMS_OBJ_IND_ID == item.PMS_OBJ_IND_ID
                  ).length == 0
                ) {
  ...
  watch: {
    ...
    //   localThis.formData.objIndicatorRelId = 0;
    //   localThis.formData.objIndicatorId=to[0].PMS_OBJ_IND_ID;
    //   localThis.formData.QUESTION =to[0].PMS_OBJ_IND_QUESTION;
    //   localThis.formData.INDICATOR=to[0].PMS_OBJ_IND;
